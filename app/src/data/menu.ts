...
export const toppingGroups: ToppingGroup[] = [
  {
    id: "nuts",
    name: "Ξηροί καρποί",
    items: [
      { id: "walnut", name: "Καρύδι" },
      { id: "hazelnut", name: "Φουντούκι" },
      { id: "almond", name: "Αμύγδαλο" },
    ],
  },
  {
    id: "biscuits",
    name: "Μπισκότα",
    items: [
      { id: "oreo", name: "Θρύψαλα Oreo" },
      { id: "digestive", name: "Digestive" },
      { id: "lotusb", name: "Μπισκότο Lotus" },
    ],
  },
  {
    id: "fruit",
    name: "Φρούτα",
    items: [
      { id: "strawberry", name: "Φράουλα" },
      { id: "banana", name: "Μπανάνα" },
      { id: "cherry", name: "Κεράσι" },
    ],
  },
  {
    id: "syrup",
    name: "Σιρόπια",
    items: [
      { id: "chocsyrup", name: "Σοκολάτα" },
      { id: "caramel", name: "Καραμέλα" },
      { id: "strawsyrup", name: "Φράουλα" },
    ],
  },
  {
    id: "candy",
...
// Κατηγορίες που παραδίδονται σε τούρτα (ζητούν στοιχεία τούρτας στο checkout)
export const CAKE_CATEGORIES = new Set(["cakes", "icecream_cakes"]);
...
export const popular: PopularProduct[] = [
