...
export function AdminOrderSoundControl() {
  ...
  return (
    <div className="fixed right-5 bottom-5 z-20 flex items-center gap-2.5 rounded-full border border-espresso/12 bg-surface px-4 py-2.5 shadow-[0_4px_18px_rgba(30,24,18,0.12)]">
      <span className="text-[13px] font-semibold text-espresso">
        🔊 Ήχος παραγγελιών: <span style={{ color: soundEnabled ? "var(--color-bronze)" : "var(--color-maroon)" }}>{soundEnabled ? "Ενεργός" : "Ανενεργός"}</span>
      </span>
